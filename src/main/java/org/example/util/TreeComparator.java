...
public class TreeComparator {
    ...
    private static int stringCompare(String val1, String val2) {
        return val1.compareTo(val2);
    }

    private static int doubleCompare(Double val1, Double val2) {
        return val1.compareTo(val2);
    }

    private static int intCompare(Integer val1, Integer val2){
        return val1.compareTo(val2);
    }
}
